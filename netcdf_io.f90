...
integer :: us1msqr_vid,us2msqr_vid,us3msqr_vid
...
subroutine write_his_netcdf
      ...
      call netcdf_check( nf90_put_var(ncid,wcube_vid,real(wcube),start=(/1, his_counter/)) )
      call netcdf_check( nf90_put_var(ncid,wfour_vid,real(wfour),start=(/1, his_counter/)) )
